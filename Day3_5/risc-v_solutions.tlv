...
\TLV
   ...
   |cpu
      ...
      @3
         ...
         `BOGUS_USE ($is_andi $is_ori $is_xori $is_addi $is_slli $is_slli $is_srli $is_and $is_or $is_xor $is_add $is_sub $is_sll $is_srl $is_sltu $is_sltiu $is_lui$is_auipc $is_jal $is_jalr $is_srai $is_slt $is_slti $is_sra);
